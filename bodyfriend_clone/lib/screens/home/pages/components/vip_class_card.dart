...
class VIPClassCard extends StatelessWidget {
  ...
  const VIPClassCard({Key? key, required this.vipclass, required this.nowDateTime}) : super(key: key);
        ...
        children: [
          Stack(
            children: [
              ...
              nowDateTime-vipclass.eventDate>0?Container(
                alignment: Alignment.center,
                width: double.infinity,
                height: MediaQuery.of(context).size.width / 2,
                decoration: BoxDecoration(color: kBlackColor.withOpacity(0.6)
                ),
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 5),
              Text(vipclass.placeName,style: const TextStyle(
                color: kGreyColor,
              ),),
            ],
          ),
