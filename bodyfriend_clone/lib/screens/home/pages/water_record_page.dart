                ...
                child: Stack(
                  children: [
                    Positioned(
                      ...
                      height: 250,
                      child: Image.asset(
                          'assets/memberships/img_water_purifier@3x.png'),
                    ),
                    const Positioned(
                      left: 0,
                      top: 20,
                    ...
                    Positioned(
                      ...
                      child: SizedBox(
                        width: 60,
                        child: Image.asset(
                            'assets/memberships/btn_water_on@3x.png'),
                      ),
                    ),
                    Positioned(
                      left: 0,
                      ...
                      child: Container(
                        decoration: const BoxDecoration(
                          image: DecorationImage(
                            image: AssetImage('assets/memberships/img_cup@3x.png'),
                          ),
                        ),
                        child: Image.asset('assets/memberships/img_cup_water@3x.png'),
                      ),
                    ),
                  ],
                ),
